import 'package:datepicker_dropdown/list_of_months_ln.dart';
import 'package:flutter/material.dart';

/// Defines widgets which are to used as DropDown Date Picker.
// ignore: must_be_immutable
class DropdownDatePickerVN extends StatefulWidget {
  ...
  DropdownDatePickerVN(
      ...
      this.dayFlex = 1,
      this.yearFlex = 2})
      : assert(["en", "zh_CN", "it_IT", "de_DE", "tr", 'fr_FR', 'es_ES', 'vi']
            .contains(locale)),
        super(key: key);
...
class _DropdownDatePickerState extends State<DropdownDatePickerVN> {
  var monthselVal = '';
  var dayselVal = '';
  var yearselVal = '';
  int daysIn = 32;
